...
#ifndef RK_GDI_GRAPHICS_BACKEND_H
#define RK_GDI_GRAPHICS_BACKEND_H

#include "RkGraphicsBackend.h"

class RkGDIGraphicsBackend final : public RkGraphicsBackend {
 public:
        RkGDIGraphicsBackend(RkCanvas* canvas);
        ~RkGDIGraphicsBackend();
...
#endif // RK_GDI_GRAPHICS_BACKEND_H
